...
IEnumerator Pickup(GameObject player)
    {
        ...
        JacobTEMPPlayer ms = player.GetComponent<JacobTEMPPlayer>(); // get player data, can change
        isBuffed = true; // set isBuffed to true

        ms.moveSpeed *= speedMultiplier; // increase movement speed by multiplier
        ...
        ms.moveSpeed /= speedMultiplier; // Revert MS buff
